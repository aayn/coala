...
the output format of the linter. The linter decorator is capable of handling
...
If your underlying tool generates a corrected file, the class generates
automatically patches for the changes made and yields results accordingly.
